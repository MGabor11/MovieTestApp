...
import com.example.movietestapp.ui.NoContainerException
import dagger.android.support.DaggerAppCompatActivity
import dagger.android.support.DaggerFragment

abstract class BaseActivity : DaggerAppCompatActivity(), FragmentCommunicator {
    ...
    @Throws(NoContainerException::class)
    override fun onNewFragmentSelected(fragment: DaggerFragment, replaceIt: Boolean, needToBackStack: Boolean) {
        if (replaceIt) {
